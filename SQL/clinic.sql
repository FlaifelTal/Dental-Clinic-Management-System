...
create table laboratory (
	...
	laboratoryPhoneNumber varchar(16) ,
...
('John Doe', '059-456-7890'),
('Alice Johnson', '059-654-3210'),
('Bob Smith', '059-123-4567');
...
('Receptionist Alice', 'Receptionist', 40000.00, '555-111-2222', 'Mon-Fri', 8, 'receptpass');
...
('059-444-3333', 'Dental Lab', 'Digital', 1, 1200001),
('059-222-1111', 'X-ray Lab', 'Printed', 2, 1200002),
('059-666-9999', 'Analysis Lab', 'Digital', 3, 1200000);
